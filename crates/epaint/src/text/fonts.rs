...
///        FontData::from_static(include_bytes!("../../../epaint_default_fonts/fonts/SourceHanSerifCN-VF.ttf"))
///    )
/// );
///
...
impl Default for FontDefinitions {
    ...
    fn default() -> Self {
        ...
        font_data.insert(
            ...
            Arc::new(FontData::from_static(SOURCECODEPRO_REGULAR)),
        );
        ...
        font_data.insert(
            ...
            Arc::new(FontData::from_static(SOURCEHANCN_VF)),
        );
